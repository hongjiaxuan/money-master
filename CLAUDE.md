...
## 目前狀態（115/09/25 更新）
- **最新（v5.75，待使用者試用後才部署）**：會計雙表重建——ReportsView「財務體檢」Tab 改建成「財務中心」（資產負債表＋損益表），移除首頁「上月財務回顧」卡片與標籤統計 Tab——
