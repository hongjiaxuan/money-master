...
## 目前狀態（115/09/04 更新）
- **最新（v5.67，待使用者試用後才部署）**：記帳畫面數字鍵縮小、跟快速記帳對齊一致——
...
- **語言**：繁體中文介面
- **SW 版本**：`money-master-v5.66`（sw.js）
...
### sw.js 版本號規則
每次更新 `index.html` 時同步遞增，目前為 `v5.66`：
```js
const CACHE_NAME = 'money-master-v5.66';
```
