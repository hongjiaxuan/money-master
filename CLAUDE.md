...
## 目前狀態（115/09/04 更新）
- **最新（v5.65，已合併並部署上線）**：快速記帳桌面小工具——MacroDroid 開啟 App 網址帶參數，自動跳出快速記帳選單——
...
- **語言**：繁體中文介面
- **SW 版本**：`money-master-v5.65`（sw.js）
...
### sw.js 版本號規則
每次更新 `index.html` 時同步遞增，目前為 `v5.65`：
```js
const CACHE_NAME = 'money-master-v5.65';
```
