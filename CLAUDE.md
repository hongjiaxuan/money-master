...
## 目前狀態（115/09/04 更新）
- **最新（v5.68，已合併並部署上線）**：Gemini 換更好的模型＋自動記帳「手機推播通知」（MacroDroid 本地通知＋深連結）——
