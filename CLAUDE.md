...
## 目前狀態（115/09/14 更新）
- **最新（v5.72，已合併並部署上線，PR #41）**：修正選卡推薦文字搜尋找不到只出現在條件說明裡的店家名稱——
